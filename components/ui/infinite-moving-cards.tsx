  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[90vw] max-w-full shrink-0 rounded-2xl border border-b-0 border-slate-200 bg-[linear-gradient(180deg,#fafafa,#f5f5f5)] px-8 py-6 md:w-[60vw] dark:border-slate-800 dark:bg-[linear-gradient(180deg,#27272a,#18181b)]"
            key={idx}
	    style={{
		  ...
		  <div className="me-3">
		    {/* TODO: change the src to dynamic profile pic */}
		    <img
		      src="/profile.svg"
		      alt="profile"
		    />
